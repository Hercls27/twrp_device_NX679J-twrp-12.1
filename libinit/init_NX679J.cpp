...
void vendor_load_properties() {
    ...
    if (sku == "NX679J") {
        load_device_properties("NX679J-EEA-user 12 SKQ1.211113.001 eng.nubia.20221210.062533 release-keys", "nubia/NX679J-EEA/NX679J-EEA:12/SKQ1.211113.001/eng.nubia.20221210.062533:user/release-keys", "NX679J", "Red Magic 7");
